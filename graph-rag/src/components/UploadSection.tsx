...
export default function UploadSection({
  ...
  const [destFolderId, setDestFolderId] = useState(defaultFolderId || "");

  useEffect(() => {
    if (defaultFolderId) setDestFolderId(defaultFolderId);
  }, [defaultFolderId]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card card-padded">
        <h2 className="label mb-4">Add file</h2>
      ...
      {/* File list */}
      <div className="card card-padded">
        <h3 className="label mb-4">Your files</h3>
